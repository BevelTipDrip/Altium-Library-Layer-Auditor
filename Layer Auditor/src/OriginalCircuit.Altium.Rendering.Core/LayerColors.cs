...
public static class LayerColors
{
    ...
    /// <summary>
    /// Gets Altium's human-readable name for a PCB layer (e.g. "Top Layer", "Mechanical 13"),
    /// matching the labels shown in Altium's Layers &amp; Colors panel.
    /// </summary>
    public static string GetName(int layerId) => layerId switch
    {
        1 => "Top Layer",
        >= 2 and <= 31 => $"Mid-Layer {layerId - 1}",
        32 => "Bottom Layer",
        33 => "Top Overlay",
        34 => "Bottom Overlay",
        35 => "Top Paste",
        ...
        37 => "Top Solder",
        38 => "Bottom Solder",
        >= 39 and <= 54 => $"Internal Plane {layerId - 38}",
        55 => "Drill Guide",
        56 => "Keep-Out Layer",
        >= 57 and <= 72 => $"Mechanical {layerId - 56}",
        73 => "Drill Drawing",
        74 => "Multi-Layer",
        81 => "Pad Holes",
        82 => "Via Holes",
